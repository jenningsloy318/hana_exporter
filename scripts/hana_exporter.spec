...
License: MIT
URL:     https://github.com/jenningsloy318/hana_exporter
...
This is an exporter that exposes information gathered from HANA database for use by the Prometheus monitoring system.
...
%config(noreplace) %{_sysconfdir}/prometheus/hana_exporter.yml
