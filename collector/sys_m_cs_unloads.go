...
const (
	// Scrape query.
	csUnloadsQuery = `SELECT COUNT(*) as CS_UNLOAD_COUNT,SCHEMA_NAME FROM "SYS"."M_CS_UNLOADS"  WHERE SCHEMA_NAME NOT  LIKE '_SYS%' GROUP BY SCHEMA_NAME ORDER BY COUNT(*) DESC;`
	// Subsystem.
