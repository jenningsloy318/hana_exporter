...
var (
	...
	globalInnoDBRowOpsDesc = prometheus.NewDesc(
		...
		"Total number of HANA InnoDB row operations.",
		[]string{"operation"}, nil,
	)
	globalPerformanceSchemaLostDesc = prometheus.NewDesc(
		...
		"Total number of HANA instrumentations that could not be loaded or created due to memory constraints.",
